...
public class UIJogador : MonoBehaviour
{
    ...
    static public float dificultymeter = 1f;
    ...
    public TMP_Text Text_upgrade_p;
    public TMP_Text Text_Sell_p;
    ...
    static public TMP_Text Text_upgrade; 
    static public TMP_Text Text_Sell; 
    ...
    void Start()
    {
        ...
        Text_upgrade = Text_upgrade_p;
        Text_Sell = Text_Sell_p;
